...
:ato
echo.&cscript //nologo slmgr.vbs /ato | find /i "successfully" > temp.txt && (echo.&echo Silahkan donasi via saweria.co/berBagiTekno untuk menyelesaikan aktivasi Windows 10 anda.&echo.& if errorlevel 2 exit) || (echo Sepertinya butuh waktu lebih, silahkan tunggu... & echo. & echo. & set /a i+=1 & timeout /t 10 >nul & goto server)&timeout /t 7 >nul&explorer "https://saweria.co/berBagiTekno"&echo.
